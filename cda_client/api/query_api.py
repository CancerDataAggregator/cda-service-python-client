...
class QueryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.mutation_counts_query = _Endpoint(
            settings={
                'response_type': (QueryCreatedData,),
                'auth': [],
            ...
            api_client=api_client,
            callable=__mutation_counts_query
        )

        def __mutation_query(
            self,
            version,
            query,
            **kwargs
