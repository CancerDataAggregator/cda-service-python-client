...
*QueryApi* | [**columns**](docs/QueryApi.md#columns) | **GET** /api/v1/columns/{version} | Returns all column names and definitions for schema
...
*QueryApi* | [**mutation_counts_query**](docs/QueryApi.md#mutation_counts_query) | **POST** /api/v1/mutations/counts/{version} | Execute Mutation Counts query
*QueryApi* | [**mutation_query**](docs/QueryApi.md#mutation_query) | **POST** /api/v1/mutations/{version} | Execute Mutation query
...
## Documentation For Models
 ...
 - [ColumnsResponseData](docs/ColumnsResponseData.md)
