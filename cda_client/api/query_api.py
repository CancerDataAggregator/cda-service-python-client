...
class QueryApi(object):
    ...
    def boolean_query(self, version, query, **kwargs):  # noqa: E501
        ...
        Execute a query composed of conditions on columns combined with boolean operators    # noqa: E501
    ...
    def sql_query(self, version, body, **kwargs):  # noqa: E501
        """Execute SQL directly on a version of the dataset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sql_query(version, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str version: Dataset version (required)
        :param str body: BigQuery SQL to run on data table (required)
        :param int offset: The number of entries to skip
        :param int limit: The numbers of entries to return
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.sql_query_with_http_info(version, body, **kwargs)  # noqa: E501

    def sql_query_with_http_info(self, version, body, **kwargs):  # noqa: E501
        """Execute SQL directly on a version of the dataset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sql_query_with_http_info(version, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('version' not in local_var_params or  # noqa: E501
                                                        local_var_params['version'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `version` when calling `sql_query`")  # noqa: E501
